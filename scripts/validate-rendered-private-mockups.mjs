...
const visibleInternalChromePatterns = [
  ...
  /\bpublic race facts\b/i,
  /\bThe public FAQ says\b/i,
  /\bThe About page says\b/i,
  /\bReview the public\b/i,
  /\bthe race page (?:describes|lists|states)\b/i,
  /\bthe race page and FAQ state\b/i,
  /\bRace visual\b/i,
  /\bPlace study\b/i,
