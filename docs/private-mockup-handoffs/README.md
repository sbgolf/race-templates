# Private Mockup Handoffs

Internal-only handoff packages for Steve review live here. They are not imported by Astro routes, not customer-facing copy, and should not be pasted into runner-facing mockup pages.
...
- evidence and verification pointers from production and local checks

Do not send these drafts to prospects without Steve approval.
